...
class SharePoint:
    ...
    def upload_file(self, file, file_name, folder_name):
        ...
        # If dealing with txt files change mode to 'r'
        with open(file, mode='rb') as file_obj:
            file_content = file_obj.read()

        # This 'upload_file' is one imported from shareplum.
        # Not the one i'm making now.
    ...
    def delete_file(self, file_name, folder_name):
        ...
        # This 'delete_file' is one imported from shareplum.
        # Not the one i'm making now.
